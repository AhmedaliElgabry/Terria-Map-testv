...
describe("WebMapTileServiceCatalogItem", function() {
  ...
  xit("given a layer pointing at a tilematrix set, calculates the correct tileMatrixMaximumLevel", function(done) {
    wmtsItem.updateFromJson({
  ...
  xit("given a layer pointing at a non-existent tilematrix set, does not set tileMatrixMaximumLevel", function(done) {
    wmtsItem.updateFromJson({
      url: "test/WMTS/with_tilematrix.xml",
      metadataUrl: "test/WMTS/with_tilematrix.xml",
