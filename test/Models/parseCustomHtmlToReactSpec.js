...
describe("parseCustomHtmlToReact and registerCustomComponentTypes", function() {
  ...
  xit("parses a chart with a src attribute", function() {
    const result = parseCustomHtmlToReact(
  ...
  xit("parses a chart with a data attribute containing csv", function() {
    // Both line feeds (\n) and backslash-n ("\n" or \\n here) work.
    const result = parseCustomHtmlToReact(
      '<chart data="x,y\n1,2\\n3,4\n5,6"></chart>'
    );
  ...
  xit("parses a chart with a data attribute containing json", function() {
    // Use &quot; for quotes.
    const result = parseCustomHtmlToReact(
  ...
  xit("parses a chart with child csv", function() {
    // Both line feeds (\n) and backslash-n ("\n" or \\n here) work.
  ...
  xit("parses a chart with child json", function() {
