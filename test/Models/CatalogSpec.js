...
describe("Catalog", function() {
  ...
  describe("updateByShareKeys", function() {
    xit("works when resolving by id", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
    ...
    xit("works when resolving by shareKeys", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
    ...
    xit("opens parent groups", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
    ...
    xit("works for multiple share keys", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
    ...
    xit("only enabled a catalog member after all those before it have finished loading", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
    ...
    xit("updates associated shared data like opacity", function(done) {
      catalog
        .updateFromJson([
          {
            name: "A",
