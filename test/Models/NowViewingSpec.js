...
describe("NowViewing without a viewer", function() {
  ...
  it("can add an item", function() {
    var item = new CsvCatalogItem(terria);
    item.name = "New catalog item";
...
describeIfSupported("NowViewing with a minimal Cesium viewer", function() {
  ...
  it("can raise an item", function() {
    var item1 = new CsvCatalogItem(terria);
    var item2 = new CsvCatalogItem(terria);

    item1.name = "New item 1";
    item2.name = "New item 2";
