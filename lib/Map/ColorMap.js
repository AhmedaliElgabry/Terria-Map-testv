...
ColorMap.stringToArray = function (str) {
  return stringToArray(str);
};

/**
 * Given a ColorMap object
 * returns css color strings, eg. "red-blue-green"
 * // TODO: Handle the case of non css colors, eg. rgb(255,0,0).
 */
ColorMap.toColorString = function (colorMap) {
