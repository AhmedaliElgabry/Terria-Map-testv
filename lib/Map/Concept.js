...
var Concept = function(name) {
  ...
  /**
   * Flag to indicate if column is shown on tabular view.  This property is observable.
   * @type {Boolean}
   * @default true
   */
  this.isActiveOnTableView = false;

  /**
   * Flag to say if this node is selectable on tabular view.  This property is observable.
   * @type {Boolean}
   */
  this.isVisibleOnTableView = false;

  /**
   * String describing tooltip to show on the workbench concept viewer
   * @type {String}
   */
 ...
 * Toggles the {@link Concept#isActive} property.
 */
Concept.prototype.toggleActiveTabular = function() {
  this.isActiveOnTableView = !this.isActiveOnTableView;
};
