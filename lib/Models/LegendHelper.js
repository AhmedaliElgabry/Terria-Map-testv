...
var defaultScalarColorMap = [
  { offset: 0.0, color: "papayawhip" },
  { offset: 0.25, color: "lightsalmon" },
  { offset: 0.5, color: "coral" },
  { offset: 0.75, color: "orangered" },
  { offset: 1.0, color: "brown" }
];
...
module.exports.defaultScalarColorMap = defaultScalarColorMap;
