...
var SmartCsvCatalogItem = require("./SmartCsvCatalogItem");
var CswCatalogGroup = require("./CswCatalogGroup");
var CswCatalogResource = require("./CswCatalogResource");
...
const RemoteConfigGroup = require("./RemoteConfigGroup");
const RemoteConfigItem = require("./RemoteConfigItem");
const ShapefileCatalogItem = require("./ShapefileCatalogItem");
...
var registerCatalogMembers = function() {
  ...
  createCatalogMemberFromType.register("smart-csv", SmartCsvCatalogItem);
  createCatalogMemberFromType.register("csw", CswCatalogGroup);
  createCatalogMemberFromType.register("georss", GeoRssCatalogItem);
  createCatalogMemberFromType.register("csw-resource", CswCatalogResource);
  createCatalogMemberFromType.register(
    "remote-config-group",
    RemoteConfigGroup
  );
  createCatalogMemberFromType.register("remote-config-item", RemoteConfigItem);
  createCatalogMemberFromType.register(
    "cesium-terrain",
  ...
  createCatalogMemberFromType.register("shapefile", ShapefileCatalogItem);
