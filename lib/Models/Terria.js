...
var UserManagementServices = require("./UserManagementServices");
...
var createBaseMapOptionsForProjection = require("../ViewModels/createBaseMapOptionsForProjection.js");
var selectBaseMap = require("../ViewModels/selectBaseMap");
import regeneratorRuntime from "regenerator-runtime";
import VectorFeatureMaskProvider from "./VectorFeatureMaskProvider.js";
import WfsFeatureSearch from "../ReactViews/Workbench/Controls/WfsFeatureSearch.js";
import scaleToGeodeticSurface from "terriajs-cesium/Source/Core/scaleToGeodeticSurface.js";
import VisualizationType from "./VisualizationType.js";
import { TableColorModes } from "../ReactViews/TableView/TableColorModes.jsx";
...
var defaultConfigParameters = {
  ...
  relatedSites: undefined,
  bingMapsKey:
    "AqdAVaMy9SW3I4_xwbx3QzIhZV3fjaadGqmDm4VvRgvuSW2GncAOViUvm0cmWlSo",
  projections: [
    {
      name: "Web Mercator",
      srs: "EPSG:3857",
      ...
      baseMaps: [
        {
          name: "Natural Colour",
          url: `https://api.maptiler.com/maps/922a76c5-8c5d-4296-8534-222f21379edf/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "NaturalColor.png"
        },
        {
          name: "Hillshading",
          url: `https://api.maptiler.com/maps/1d9b5555-0bb1-4afb-ac7e-49f65d197192/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "Hillshading.png"
        },
        {
          name: "Basic",
          url: `https://api.maptiler.com/maps/ddbf6139-7734-42a8-b1fa-7533942a9cd2/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "Basic.png"
        ...
        {
          name: "Dark",
          url: `https://api.maptiler.com/maps/0f0aab94-39dc-4c19-b1a8-518a707e6614/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "Dark.png"
        ...
        {
          name: "Land And Water",
          url: `https://api.maptiler.com/maps/bda7de00-ab79-409e-bf23-4e90c1d04000/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "LandAndWater.png"
        },
        {
          name: "Open Street Map",
          url: `https://api.maptiler.com/maps/265e83f7-02d8-458a-aae2-417cdce33693/{z}/{x}/{y}.jpg?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
        ...
        {
          name: "Topographique",
          url: `https://api.maptiler.com/maps/1739a9c6-70a4-45b4-b377-344c2760b950/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "Topographique.png"
        },
        {
          name: "Gray",
          url: `https://api.maptiler.com/maps/4617411c-0c35-43e4-9be4-5de61f36d9b1/{z}/{x}/{y}.png?key=${KEY}`,
          type: "url-template",
          attribution:
            '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
          thumbnail: "Gray.png"
        },
        {
          ...
          type: "url-template",
          url: `https://data.apps.fao.org/map/gsrv/gsrv1/boundaries/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&FORMAT=image/png&tiled=true&STYLES&LAYERS=gray_hr_sr_ob_dr&WIDTH=256&HEIGHT=256&SRS=EPSG%3A4326&BBOX=0,-180,180,0`,
          thumbnail: "White.png"
        },
        {
          name: "Bing Maps",
...
var Terria = function(options) {
  ...
  /**
   * Global flag for mobile env
   * @type {Boolean}
   */
  this.isCommonMobilePlatform = isCommonMobilePlatform();
  ...
  /**
   * Access for user management services
   * @type {UserManagementServices}
   */
  this.userManagementServices = new UserManagementServices(this);
  ...
  this.catalogItemAdded = null;
  this.catalogItemRemoved = null;

  /**
   * Gets or sets a variable that keeps track if the current user, who could be anonymous, has unauthorizrd access
   * @type {Boolean}
   */
  this.hasUnauthorizedAccessForSharedData = undefined;

  /**
   * Controls the current view of the app.
   * Tracks if maps, charts, or tables are being used to visualize data
   * Can be ViewType.MAP, ViewType.CHART, ViewType.TABLE
   * @type {ViewType}
   * @default {ViewType.MAP}
   */
  this.viewType = VisualizationType.MAP;

  /**
   * Catalog item to be visualized in tabular form
   * @type {CatalogItem}
   * @default {null}
   */
  this.nowViewingTable = null;

  /**
   * Contains the sort columns of the tabular catalog item
   * @type {Array}
   */
  this.tableSortColumns = [];
  /**
   * Holds filter information for tabular catalog items
   * @type {Object}
   */
  this.tableFilters = {};

  /**
   * Contains the default color mode of the table view. Can be configured from config-prod.
   * @type {string}
   * @default {'dark'}
   */
  this.tableColorMode = defaultValue(
    this.getLocalProperty("tableViewColorMode") ||
      options.tabularViewSettings?.defaultColorMode,
    TableColorModes.light
  );

  /**
   * Controls how tabular catalog item is presented. It can be either "grid" or "pivot"
   * @type {string}
   * @default {'grid'}
   */
  this.tableType = defaultValue(options.tabularViewSettings?.tableType, "grid");

  /**
   * Controls the number of decimal places to show on tabular view
   * @type {Number}
   * @default {2}
   */
  this.tableDecimalPlaces = 2;

  /* List of projections */
  this.projections = defaultValue(
    options.projections,
    defaultConfigParameters.projections
  );

  this.activeProjection = defaultValue(options.activeProjection, undefined);

  this.allBaseMaps = defaultValue(options.allBaseMaps, undefined);

  this.changeProjectionAndSelectBaseMap(this.activeProjection);
  this.setBaseMap(this.baseMapName, false);
  ...
  knockout.track(this, [
    ...
    "previewedItemId",
    "hasUnauthorizedAccessForSharedData",
    "stories",
...
Terria.prototype.start = function(options) {
  ...
  return loadJson5(options.configUrl).then(function(config) {
    ...
    cp.availableLanguages = defaultValue(options.availableLanguages, []);
    ...
    that.projections = defaultValue(
      cp.projections,
      defaultConfigParameters.projections
    );

    that.userManagementServices.loginOrRefreshSession().then(response => {
      that.userManagementServices.isLoggedIn = true;
    });
    ...
    return that.serverConfig
      ...
      .then(function() {
        ...
        const cleanMode = isCleanMode(applicationUrl);

        if (defined(that.userProperties.map) && cleanMode) {
          ...
          persistViewerMode &&
          defined(that.getLocalProperty("viewermode"))
        ) {
        ...
        that.changeProjectionAndSelectBaseMap(that.activeProjection, cleanMode);
        that.setBaseMap(that.baseMapName, !cleanMode);
        that.userManagementServices.getGeometries();
 ...
 */
Terria.prototype.updateApplicationUrl = async function(newUrl) {
  ...
  if (this.userManagementServices.isLoggedIn) {
    var payload = {
      project_name:
        uri
          .pathname()
          .replace(/^\/|\/$/g, "")
          .replace(/\//g, "-") || "hand-in-hand",
      lang: "en"
    };
    try {
      var response = await axios.post("/private/config", payload, {
        withCredentials: true
      });
      var privateInitSources = response.data.init_sources;
      if (Array.isArray(privateInitSources) && privateInitSources.length > 0) {
        initSources = initSources.concat(privateInitSources);
      }
    } catch (error) {
      if (error?.response?.status != 401 && error?.response?.status != 404) {
        that.error.raiseEvent({
          title: i18next.t("models.terria.loadingPrivateInitSourceErrorTitle"),
          message: i18next.t(
            "models.terria.loadingPrivateInitSourceErrorMessage",
            {
              message:
  ...
  return when(promise).then(function() {
    ...
    return loadInitSources(that, initSources)
      .then(promise => {
        return (promise || when()).then(() => initSourceFromUrl(that));
      })
      .then(promise => {
        const { mask, key, value } = that.userProperties;
        if (!mask) {
          return promise;
        }

        const tryCreateMask = (featureSearchProvider, maskProvider) => {
          featureSearchProvider.fetchLayerAttributes().then(() => {
            const featurePromise = featureSearchProvider.searchFeatures(
              { name: key },
              value
            );

            if (!featurePromise) return promise;
            ...
            return featurePromise.then(features => {
              ...
              const featureBbox = Rectangle.fromDegrees(
                bbox[0],
                bbox[1],
                bbox[2],
                bbox[3]
              ...
              maskProvider.mask(key, value, featureBbox);
            });
          });
        };
        ...
        var item = that.nowViewing.items.find(
          a =>
            a.isShown &&
            a.isEnabled &&
            (a.id?.trim() == mask.trim() ||
              a.name?.toLowerCase()?.trim() == mask.toLowerCase().trim())
        );
        const maskProvider = new VectorFeatureMaskProvider(that, item);
        const featureSearchProvider = new WfsFeatureSearch(item);

        if (that.currentViewer !== that._noViewer) {
          tryCreateMask(featureSearchProvider, maskProvider);
        } else {
...
Terria.prototype.addInitSource = function(initSource, fromStory = false) {
  ...
  this.changeProjectionAndSelectBaseMap(initSource.activeProjection);
  if (defined(initSource.baseMapName)) {
    this.setBaseMap(initSource.baseMapName, false);
  }
  ...
  // Having this on top matters
  // Because the code below have early exit functions which may return before reaching this piece of code
  if (defined(initSource.viewType)) {
    promise.then(() => {
      this.viewType = initSource.viewType;
      this.activatedFromStory = fromStory;
      console.info("Setting visualizer to " + initSource.viewType);
    });
  }
  ...
  if (defined(initSource.mask)) {
    const mask = initSource.mask;

    promise.then(function() {
      var removeViewLoadedListener;

      var loadMaskedFeature = function() {
        if (defined(removeViewLoadedListener)) {
          removeViewLoadedListener();
        }

        // If mask was created using the focus button on feature info section
        // then it will have providerCoords
        if (mask.providerCoords) {
          const { pickCoords, providerCoords } = mask;

          // masking should take precedence over picking
          that.currentViewer._pickedFeatures = null;

          that.currentViewer.pickFromLocation(pickCoords, providerCoords, []);

          var featureIndex = {};
          return that.pickedFeatures.allFeaturesAvailablePromise.then(
            function() {
              that.pickedFeatures.features.forEach(function(entity) {
                var hash = hashEntity(entity, that.clock);
                var feature = entity;
              ...
              var selectedFeature = featureIndex[mask.hash]?.[0];

              if (selectedFeature) {
                that.selectedFeature = selectedFeature;
                that.currentViewer._createMaskAroundFeature(
                  that.selectedFeature,
                  mask
                );
              }
        ...
        // If the mask was created using the AttributeFilter component
        // then we have to the bounding box and search criteria to find it
        // todo: find a way to find coordinates
        var maskedLayer = that.nowViewing.items.find(function(item) {
          return (
            item.isEnabled && item.isShown && item.layer == mask.sourceLayer
          );
        });

        const maskProvider = new VectorFeatureMaskProvider(that, maskedLayer);

        const rectangle = new Rectangle(
          mask.rectangle.west,
          mask.rectangle.south,
          mask.rectangle.east,
          mask.rectangle.north
        );
        maskProvider.mask(
          mask.searchKey,
          mask.searchValue,
  ...
  if (defined(initSource.table)) {
    const tableConfig = initSource.table;

    if (tableConfig && this.viewType === VisualizationType.TABLE) {
      const table = that.nowViewing.items.find(function(item) {
        return item.uniqueId == tableConfig.currentTable;
      });

      runLater(() => {
        that.nowViewing.tabularItems.forEach(item => {
          if (item.uniqueId !== table.uniqueId) {
            item.isShown = false;
          }
        });
      }, 100);

      this.tableIsShared = true;
      this.tableType = tableConfig.tableType;
      this.currentPivotViews = tableConfig.currentPivotView;
      this.tableTop = tableConfig.tableTop || 0;
      this.nowViewingTable = table;
      this.tableSortColumns = tableConfig.tableSortColumns;
      this.tableFilters = tableConfig.tableFilters;
    }
  }
...
Terria.prototype.setProjectionAndCreateBaseMaps = function(selectedProjection) {
  this.activeProjection = selectedProjection;
  const { baseMaps } = this.activeProjection;
  this.allBaseMaps = createBaseMapOptionsForProjection(this, baseMaps);
  this.setLocalProperty("activeprojection", this.activeProjection.srs);
  if (!this.activeProjection.supports3d) {
    this.viewerMode = ViewerMode.Leaflet;
    this.setLocalProperty("viewermode", ViewerMode.Leaflet);
  }
  this.nowViewing.reproject();
  this.currentViewer.notifyRepaintRequired();
};

Terria.prototype.changeProjectionAndSelectBaseMap = function(
  selectedProjection,
  cleanMode = false
) {
  let activeProjection;
  if (!cleanMode) {
    activeProjection = this.projections.find(
      x => x.srs == this.getLocalProperty("activeprojection")
    );
  }
  activeProjection =
    selectedProjection ||
    activeProjection ||
    this.projections.find(x => x.default) ||
    this.projections[0];

  if (
    defined(this.activeProjection) &&
    activeProjection.srs == this.activeProjection.srs
  ) {
    return;
  }
  this.setProjectionAndCreateBaseMaps(activeProjection);
};

Terria.prototype.setBaseMap = function(baseMapName, cleanMode) {
  if (defined(baseMapName)) {
    this.baseMapName = baseMapName;
  }
  this.baseMap = selectBaseMap(
    this,
    this.allBaseMaps,
    this.allBaseMaps[0].catalogItem.name,
    cleanMode
  );
};
...
function initSourceFromUrl(terria) {
  if (!location.href.includes("source=") || !location.href.includes("type="))
    return when();

  try {
    return loadInitFromUrl(terria).then(config => {
      if (defined(config)) {
        return terria.addInitSource(config);
      }
    });
  } catch (err) {
    console.error(err);
...
function loadInitFromUrl(terria) {
  const userProps = terria.userProperties;
  const homeCamera = {
    north: 10.0,
    east: 100.0,
    south: 10.0,
  ...
  if (!userProps.source && !userProps.type) return when();

  const item = {
    id: defaultValue(userProps.id, "Added From Url"),
    name: defaultValue(userProps.name, "Added From Url"),
    type: userProps.type,
    url: userProps.source,
    isEnabled: true,
    zoomOnEnable: true
  };

  item.layers = defaultValue(userProps.layers, "");
  item.cql_filter = userProps.cql_filter;
  const link = location.href; //.replaceAll("%22", '"');
  const findRx = /source=(%22|\")[\s\S]*(%22|\")/;
  const replaceRx = /source=(%22|\")/;

  if (findRx.test(link)) {
    let result = findRx.exec(link)[0];
    result = result.replace(replaceRx, "").replace("%22", "");
...
function isCleanMode(applicationUrl) {
  var uri = new URI(applicationUrl);
  var hash = uri.query();
  var hashProperties = queryToObject(hash);
  return Object.keys(hashProperties).includes("clean");
}
