  ...
  return shareLinkPromise
    .then(shareLink => {
      const feedbackData = {
        ...
        currentUrl: location.href, // this will help us see the subsites and any parameter user may be using
        buildVersion:
          (terria.customProperties && terria.customProperties.buildVersion) ||
          "NA"
      };
      if (
