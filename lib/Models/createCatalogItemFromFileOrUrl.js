...
var createUserDataAttribution = require("./createUserDataAttribution");
...
function loadItem(newCatalogItem, name, fileOrUrl) {
  if (typeof fileOrUrl === "string") {
    ...
    newCatalogItem.attribution = createUserDataAttribution(false);
  } else {
    ...
    newCatalogItem.attribution = createUserDataAttribution(
      false,
      newCatalogItem
    );
  }
