...
var TerriaViewer = function(terria, options) {
  ...
  this.observeSubscriptions.push(
    knockout
      .getObservable(this.terria, "activeProjection")
      .subscribe(function() {
        changeProjection(this);
      }, this)
  );
...
TerriaViewer.prototype.selectLeaflet = function() {
  ...
  if (this.terria.activeProjection.srs == "EPSG:4326") {
    crs = new L.Proj.CRS(
      "EPSG:4326",
  ...
  map = L.map(this._mapContainer, mapOptions).setView([-28.5, 135], 5);
...
function initializeTerrainProvider(terriaViewer) {
  ...
  if (!terriaViewer.terria.configParameters.hideTerriaLogo) {
    ...
    const faoLogo = require("../../wwwroot/images/fao_logo.png");
    terriaViewer._defaultTerriaCredit = new Credit(
      '<div id="terriaLogoWrapper"><a id="terriaLogo" href="http://www.fao.org/home/en/" target="_blank" rel="noopener noreferrer" ><img src="' +
        faoLogo +
        '" title="Built with Terria"/> </a> </div>' +
        '<a href="https://www.fao.org/contact-us/terms/en/" target="_blank" rel="noopener noreferrer"' +
        'title="Food and Agriculture Organization of the United Nations">© FAO </a>',
      true
    );
  } else {
