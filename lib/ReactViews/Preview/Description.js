...
const Description = createReactClass({
  ...
  render() {
    ...
    const description = this.decodeHtmlEntities(catalogItem.description);

    return (
      <div className={Styles.description} ref={this.rootRef}>
        <If
          condition={
        ...
        >
          <div>
            ...
            {parseCustomMarkdownToReact(description, {
        ...
        <If condition={catalogItem.dataUrlType === "local"}>
          <p key="local">{t("description.dataLocal")}</p>
        </If>
        ...
        >
          <p key="notLocal">{t("description.dataNotLocal")}</p>
        </If>
          ...
          <If condition={catalogItem.url}>
            ...
            <Choose>
              <When condition={this.props.printView}>
                <code>
                  {catalogItem.url +
                    (catalogItem.type === "smart-csv" &&
                    catalogItem.filterParameters
                      ? "?" + catalogItem.filterParameters
                      : "")}
                </code>
              </When>
              <When condition={catalogItem.type === "smart-csv"}>
                <p key="smart-csv-description">
                  <a
                    href={catalogItem.url + `?` + catalogItem.filterParameters}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {catalogItem.url + `?` + catalogItem.filterParameters}
                  </a>
                </p>
              </When>
              <Otherwise>
          ...
          >
            ...
            <p>
              <Choose>
                ...
                >
                  {catalogItem.dataUrlType.indexOf("wfs") === 0 && (
                    <Trans i18nKey="description.useLinkBelow">
                      <a
