...
const DataPreviewMap = createReactClass({
  ...
  UNSAFE_componentWillMount() {
    ...
    this.terriaPreview = new Terria({
      ...
      activeProjection: this.props.terria.activeProjection,
      allBaseMaps: this.props.terria.allBaseMaps
    });
    ...
    const positron = new UrlTemplateCatalogItem(this.terriaPreview);
    positron.name = this.terriaPreview.baseMap.name;
    positron.url = this.terriaPreview.baseMap.url;
    positron.opacity = 1.0;
    positron.isRequiredForRendering = true;
    positron.attribution = this.terriaPreview.baseMap.attribution;
