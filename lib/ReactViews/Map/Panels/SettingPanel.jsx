...
const SettingPanel = createReactClass({
  ...
  onProjectionChange(selectedProjection) {
    this.props.terria.changeProjectionAndSelectBaseMap(selectedProjection);
    this.props.terria.setBaseMap(this.props.terria.baseMapName, true);
  },
      ...
      >
              ...
              <li key={viewerMode} className={Styles.listItem}>
                <button
                  ...
                  disabled={
                    ...
                    !this.props.terria.activeProjection.supports3d
                  }
                >
        ...
        <If
          condition={
            ...
            this.props.terria.projections.length > 1
          }
        >
          <div className={DropdownStyles.section}>
            <label className={DropdownStyles.heading}>
              {t("settingPanel.selectProjection")}
            </label>
            <Dropdown
              options={this.props.terria.projections}
              selected={this.props.terria.activeProjection}
              theme={{
                list: Styles.dropdownList,
                button: Styles.dropdownButton,
                btnOption: Styles.btnOption
              }}
              selectOption={this.onProjectionChange}
        ...
        <div className={classNames(Styles.baseMap, DropdownStyles.section)}>
          ...
          <ul className={Styles.baseMapSelector}>
            <For each="baseMap" index="i" of={this.props.terria.allBaseMaps}>
