...
const GLYPHS = {
  ...
  pencilDraw: require("../../wwwroot/images/icons/pencil_draw.svg"),
  export: require("../../wwwroot/images/icons/export.svg"),
  camera: require("../../wwwroot/images/icons/camera.svg"),
  sepal: require("../../wwwroot/images/icons/sepal.svg"),
  sepalLight: require("../../wwwroot/images/icons/sepal-light.svg"),
  radar: require("../../wwwroot/images/icons/radar.svg"),
  person: require("../../wwwroot/images/icons/person.svg"),
  sort: require("../../wwwroot/images/icons/sort.svg"),
  sortArrow: require("../../wwwroot/images/icons/sort-arrow.svg"),
  grid: require("../../wwwroot/images/icons/grid.svg"),
  pivot: require("../../wwwroot/images/icons/pivot.svg"),
  clockCancel: require("../../wwwroot/images/icons/clock-cancel.svg"),
  excel: require("../../wwwroot/images/icons/excel.svg"),
  csv: require("../../wwwroot/images/icons/csv.svg"),
  tour: require("../../wwwroot/images/icons/tour.svg"),
  help: require("../../wwwroot/images/icons/help.svg"),
  globe: require("../../wwwroot/images/icons/globe.svg"),
  edit: require("../../wwwroot/images/icons/edit.svg"),
  translate: require("../../wwwroot/images/icons/translate.svg")
};
