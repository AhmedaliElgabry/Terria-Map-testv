...
const DataCatalogGroup = createReactClass({
  ...
  render() {
    ...
    if (
      ...
      group.customProperties.allowAnalysis &&
      group.items
    ) {
    ...
    return (
      <CatalogGroup
        ...
        flatStructureLoading={group.flatStructureLoading}
        emptyMessage={t("dataCatalog.groupEmpty")}
        onClick={this.clickGroup}
        removable={
          group.userManagmentServices ? undefined : this.props.removable
        }
        ...
        <If condition={this.isOpen()}>
          <For each="item" of={group.items}>
            <DataCatalogMember
              ...
              removable={
                group.userManagmentServices ? this.props.removable : undefined
              }
              terria={this.props.terria}
            />
          </For>
